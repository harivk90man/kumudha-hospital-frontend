...
export const mockPlatformUsers: PlatformUser[] = [
  { id: 'usr-doc-001', fullName: 'Dr. K Naveen Kumar', email: 'naveen@kumudha.in',  role: 'doctor',          tenantId: 'ten-001', tenantName: 'Kumudha Hospital', isActive: true, lastLoginAt: minutesAgo(30),  createdAt: '2024-09-01T09:00:00Z' },
  { id: 'usr-doc-002', fullName: 'Dr. Anand Krishnan',  email: 'anand@kumudha.in',   role: 'doctor',          tenantId: 'ten-001', tenantName: 'Kumudha Hospital', isActive: true, lastLoginAt: minutesAgo(120), createdAt: '2024-09-05T09:00:00Z' },
  { id: 'usr-doc-003', fullName: 'Dr. Meera Suresh',    email: 'meera@kumudha.in',   role: 'doctor',          tenantId: 'ten-001', tenantName: 'Kumudha Hospital', isActive: true, lastLoginAt: minutesAgo(45),  createdAt: '2024-09-07T09:00:00Z' },
  ...
  { id: 'usr-doc-003b', fullName: 'Dr. Meera Suresh',   email: 'meera@sankara.in',   role: 'doctor',    tenantId: 'ten-002', tenantName: 'Sankara Speciality', isActive: true, lastLoginAt: minutesAgo(60),  createdAt: '2024-11-08T09:00:00Z' },
];
...
export const mockLookups: Record<string, LookupRow[]> = {
  ...
  allergies: [
    { id: 'lkp-a1', code: 'penicillin', label: 'Penicillin',          notes: 'Drug class — antibiotic.', isActive: true },
    { id: 'lkp-a2', code: 'sulfa',      label: 'Sulfa',               notes: 'Drug class — antibiotic.', isActive: true },
    { id: 'lkp-a3', code: 'nsaid',      label: 'NSAID',               notes: 'Drug class — analgesic.',  isActive: true },
...
export const mockAudit: AuditEntry[] = [
  ...
  { id: 'aud-004', occurredAt: minutesAgo(35),   actorName: 'Dr. K Naveen Kumar', actorRole: 'doctor',    action: 'consultation.locked', resourceType: 'consultation', resourceId: 'OP-2026-00121',   severity: 'info' },
